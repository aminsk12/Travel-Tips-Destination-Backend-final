...
const getAllUserFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const usersQueryBuilder = new QueryBuilder_1.default(user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.find({ verified: false }), query)
        .fields()
        .paginate()
        .sort()
        .filter()
...
const getAllPremiumUserFromDB = (query) => __awaiter(void 0, void 0, void 0, function* () {
    const usersQueryBuilder = new QueryBuilder_1.default(user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.find({ verified: true }), query)
        .fields()
        .paginate()
        .sort()
        .filter()
...
const getAlPremiumUserForAnalytics = () => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.find({ verified: true }));
    return result;
});
const updateUserStatus = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.findByIdAndUpdate(id, { status: payload === null || payload === void 0 ? void 0 : payload.status }, { new: true }));
    if (!result) {
...
const updateUserRole = (id, payload) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.findByIdAndUpdate(id, { role: payload.role }, { new: true }));
    if (!result) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "User not found");
    }
    return result;
...
const getUserFromDB = (id) => __awaiter(void 0, void 0, void 0, function* () {
    const result = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.findById(id));
    if (!result) {
...
const unFollowUser = (userId, unFollowedUserId) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        ...
        const unFollowedUser = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.findById(unFollowedUserObjectId).session(session));
        ...
        session.endSession();
        return {
            message: `You have unfollowed ${unFollowedUser === null || unFollowedUser === void 0 ? void 0 : unFollowedUser.name}`,
        };
    }
    catch (error) {
        // If any error occurs, abort the transaction
...
const getSingleUserAllPostsFromDB = (id, query) => __awaiter(void 0, void 0, void 0, function* () {
    const user = yield (user_model_1.User === null || user_model_1.User === void 0 ? void 0 : user_model_1.User.findById(id));
    if (!user) {
        throw new AppError_1.default(http_status_1.default.NOT_FOUND, "User not found");
    }
    if ((user === null || user === void 0 ? void 0 : user.status) === user_constants_1.USER_STATUS.BLOCKED) {
